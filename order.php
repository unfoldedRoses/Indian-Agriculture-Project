...
<body>
    ...
    <div class="gradient-border" id="box">Animated 
        <hr>
        <h5> Order ID: <?php echo (!empty($arr['transaction_id']))? $arr['transaction_id'] : ""; ?></h5>
        <br>
        <h5> Name: <?php echo (!empty($arr['name']))? $arr['name'] : ""; ?> </h5>
        <br>
        <h5> Email Address: <?php echo (!empty($arr['email']))? $arr['email'] : ""; ?> </h5>
        <br>
        <h5> Your Address: <?php echo (!empty($arr['add1']))? $arr['add1'] : ""; ?> </h5>
        <br>
        <h5> City: <?php echo (!empty($arr['city_name']))? $arr['city_name'] : ""; ?> </h5>
        <br>
        <h5> State: <?php echo (!empty($arr['state_name']))? $arr['state_name'] : ""; ?> </h5>
        <br>
        <h5> Pin code: <?php echo (!empty($arr['pincode']))? $arr['pincode'] : ""; ?></h5>
        <br>
        <!-- <h5>Total :<?php // $_SESSION['total']; ?></h5> -->
       
        <h5>Total :<?php echo number_format($total, 2); ?></h5>
    </div>
    <br>CSS<br>Gradient Border</div>
    <table> 
        <button>
          Find out more
        </button>
