    ...
    <div class="contact-box-main">
        <div class="container">
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="name" name="fullname" placeholder="Full Name" required data-error="Please enter your name">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="subject" name="state" placeholder="State" required data-error="Please enter your City">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="subject" name="pin" placeholder="State" required data-error="Please enter your City">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-8">
                ...
                <table class="cel font-weight-bold">
                    <tr class="text-info">
