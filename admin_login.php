...
<body>
    ...
    <div class="contact-box-main">
      ...
      <div class="container h-100">
        ...
        <form action="" class="col-md-9 font-weight-bold"  method="post">
                        ...
                        <div class="col-md-6 d-flex justify-content-center align-items-center">
                            <div class="AppFormLeft">
                                ...
                                <div class="form-group position-relative mb-4">
                                        ...
                                        <input type="text" class="form-control border-top-0 border-right-0 border-left-0 rounded-0 shadow-none" name="username" value="admin">
                                        <i class="fa fa-user-o"></i>
                                </div>
                                <div class="form-group position-relative mb-4">
                                         <input type="password" class="form-control border-top-0 border-right-0 border-left-0 rounded-0 shadow-none"  name="password" value="admin" placeholder="Password">
                                        <i class="fa fa-key"></i>
